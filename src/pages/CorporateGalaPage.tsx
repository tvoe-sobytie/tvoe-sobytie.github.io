...
export default function CorporateGalaPage() {
    useDocumentMeta(
        'Корпоративные гала-вечера и юбилеи компаний | Твоё событие',
        'Торжественные награждения и масштабные праздники для сотрудников, которые укрепляют корпоративный дух.'
    );
    ...
    const services = [
        'Разработка HR-концепции: трансляция ценностей и миссии бренда через форматы шоу, сценарий и интерактивы.',
        'Организация церемоний награждения: разработка механики вручения премий, создание графики для экранов, подбор наградной атрибутики.',
        'Масштабная логистика: организация трансфера для сотен сотрудников, координация потоков гостей, администрирование гардероба и зон регистрации.',
        'Менеджмент площадки и кейтеринга: контроль зонирования, технического райдера площадки и бесперебойной работы банкетной службы.'
    ];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        Корпоративные гала-вечера и юбилеи компаний
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        торжественные награждения, масштабные праздники для сотрудников
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Масштабные корпоративные события, объединяющие сотни сотрудников и партнёров.
                        Мы создаём праздники, которые заряжают энергией, укрепляют корпоративный дух
                        ...
                        >
                            {galleryImages.map((img, index) => (
                                ...
                                >
                                    <img
                                        src={img}
                                        alt={`Корпоративное событие ${index + 1}`}
