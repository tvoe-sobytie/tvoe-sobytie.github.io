...
export default function AnniversariesPage() {
    useDocumentMeta(
        'Юбилеи и знаковые дни рождения | Твоё событие',
        'Сценарные праздники и юбилеи персон или компаний с авторской концепцией и полным сопровождением.'
    );
    ...
    const services = [
        'Разработка авторского сценария: создание сюжетной линии праздника (кинопремия, исторический бал, мультимедийное шоу) вокруг личности именинника.',
        'Сбор и производство контента: создание уникальных биографических видеороликов, интервью со знаковыми гостями, фильмов-сюрпризов.',
        'Зонирование пространства: проектирование концептуальных фотозон, приветственных интерактивных зон (welcome-space) и зон отдыха (chill-out).',
        'Управление банкетной службой: разработка эксклюзивного меню совместно с шеф-поваром, контроль стандартов премиального сервиса и тайминга выноса блюд.',
        'Администрирование VIP-гостей: встреча, рассадка, организация безопасности, координация доставки подарков и цветов.'
    ];

    const anniversaryGallery: string[] = [];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        Юбилеи и знаковые дни рождения
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        сценарные праздники, юбилеи компаний или персон
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Каждый юбилей — это веха, достойная масштабного и душевного празднования.
                        Мы создаём сценарии, которые отражают личность и достижения именинника,
                        будь то частное лицо или целая компания.
                    </p>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        >
                            {anniversaryGallery.map((img, index) => (
                                <div
                                    key={index}
                                ...
                                >
                                    <img
                                        src={img}
                                        alt={`Юбилейная атмосфера ${index + 1}`}
