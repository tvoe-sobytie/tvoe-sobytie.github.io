...
export default function WeddingsPage() {
    useDocumentMeta(
        'Режиссёрские свадьбы под ключ | Твоё событие',
        'Организация свадеб от камерных концептуальных церемоний до масштабных свадебных шоу в любом городе России.'
    );
    ...
    const services = [
        'Разработка уникальной режиссерской концепции: создание индивидуального сценария, основанного на вашей истории любви, без банальных конкурсов.',
        'Полный технический и визуальный продакшен: проектирование декораций, разработка светового партитурного шоу, подбор звукового оборудования экспертного уровня.',
        'Кастинг и менеджмент артистов: привлечение топовых ведущих, кавер-групп, звезд эстрады и оригинальных перформансов, координация их райдеров.',
        'Тайм-менеджмент свадебного дня: поминутный логистический план для пары, гостей и подрядчиков, контроль работы кухни и подачи блюд.',
        'Свадебный консалтинг: помощь в подборе образов, организация репетиции свадебного танца, подбор и заказ эксклюзивного торта.',
        'Многослойный контроль: координация площадки командой из нескольких менеджеров с раннего утра до демонтажа декораций ночью.'
    ];

    const weddingGallery: string[] = [];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="mb-8">
                    ...
                    >
                        ...
                        <span className="text-sm tracking-[0.1em] uppercase font-semibold">Вернуться к событиям</span>
                    </button>
                </div>
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        Режиссерские свадьбы
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        от камерных концептуальных до масштабных свадебных шоу
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Мы создаём свадьбы, которые становятся легендами. От уютных церемоний в кругу близких
                        до грандиозных шоу с сотнями гостей. Каждая деталь продумана, каждый момент — под контролем.
                    </p>
                        ...
                        >
                            {weddingGallery.map((img, index) => (
                                ...
                                >
                                    <img
                                        src={img}
                                        alt={`Свадебная атмосфера ${index + 1}`}
