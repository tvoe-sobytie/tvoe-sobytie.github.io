...
export default function FashionShowsPage() {
    useDocumentMeta(
        'Модные показы и арт-перформансы | Твоё событие',
    ...
    const services = [
        'Режиссура дефиле и перформансов: постановка проходок моделей, синхронизация света, музыки и видеоконтента с шагом моделей.',
        'Бэкстейдж-менеджмент: организация пространства для стилистов, визажистов и моделей, администрирование зон примерки и тайминга выходов.',
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        Модные показы и арт-перформансы
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        светские события, интеграция искусства и брендов
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Там, где мода встречается с искусством. Мы создаём показы и перформансы,
                        которые становятся главными событиями сезона и привлекают внимание медиа.
                    </p>
