...
export default function MicePage() {
    useDocumentMeta(
        'MICE и выездные тимбилдинги | Твоё событие',
        'Организация деловых и развлекательных поездок, тимбилдингов и выездных мероприятий по всей России.'
    );
    ...
    const services = [
        'Travel-логистика под ключ: бронирование авиа- и ж/д билетов, отелей, организация групповых трансферов в любом городе РФ.',
        'Разработка программы: совмещение деловых сессий с экстремальными, спортивными или интеллектуальными тимбилдингами.',
        'Координация на местах: сопровождение группы нашими менеджерами 24/7, решение любых форс-мажорных ситуаций в режиме реального времени.'
    ];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        MICE и выездные тимбилдинги
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        организация деловых и развлекательных поездок для компаний в России
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Путешествия, которые объединяют команду и заряжают энергией. Полный цикл организации
                        деловых поездок, тимбилдингов и выездных мероприятий по всей России.
                    </p>
