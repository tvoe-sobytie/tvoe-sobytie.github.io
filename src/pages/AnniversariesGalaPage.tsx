...
export default function AnniversariesGalaPage() {
    useDocumentMeta(
        'Годовщины и семейные гала-ужины | Твоё событие',
        'Закрытые VIP-приёмы для близкого круга: изысканная атмосфера и внимание к каждой детали.'
    );
    ...
    const services = [
        'Поиск секретных и нестандартных локаций: подбор закрытых особняков, премиальных крыш, загородных вилл или исторических залов.',
        'Разработка камерной атмосферы: создание утонченной флористической концепции, подбор коллекционного текстиля и дизайнерской посуды.',
        'Индивидуальный подбор интерактивов: приглашение сомелье для винного казино, организация иммерсивного театра или живого струнного квартета.',
        'Конфиденциальность и безопасность: обеспечение полной приватности мероприятия, подписание NDA (соглашения о неразглашении) со всеми подрядчиками.'
    ];

    const galaGallery: string[] = [];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-stone-900 font-bold tracking-wide drop-shadow-md">
                        Годовщины и семейные гала-ужины
                    </h1>
                    <p className="text-xs tracking-[0.2em] text-stone-700 uppercase font-semibold mt-3 drop-shadow-sm">
                        закрытые VIP-приемы для близкого круга
                    </p>
                </div>

                <div className="max-w-3xl mx-auto text-center mb-12">
                    <p className="text-stone-700 text-base md:text-lg leading-relaxed font-medium">
                        Изысканные вечера для самых важных людей. Мы создаём атмосферу абсолютного комфорта,
                        где каждая деталь говорит о внимании к гостям. Идеальный выбор для празднования
                        семейных дат в кругу самых близких.
                    </p>
